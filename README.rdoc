...
The General Object Mapper maps ruby objects to different storage engines and vice versa. The interface is designed to
...
saved during the storage and the fetch instantiate a new object using the constructor with no arguments. If this
doesn't fit your needs, the already initiated object can be passed to the fetch method.

  book = GOM::Storage.fetch book_id, Book.new(...)

The instance variables of the initialized of the given object, will be set with the stored values.
